...
- Always write complete files, never truncate
- Use GDScript 4.x syntax only
- All signals go through EventBus autoload
- Never use player input (this is a simulation)
- Max file length: write full code even if long
